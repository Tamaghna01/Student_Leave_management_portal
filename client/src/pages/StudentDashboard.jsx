  ...
  return (
    <DashboardLayout pageTitle="Student Dashboard">
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Link to="/apply-leave" id="apply-leave-btn" className="btn-primary flex-shrink-0">
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-5">
          ...
          <Link to="/history" className="text-xs text-primary-600 hover:text-primary-700 font-medium transition-colors">
            View all →
          </Link>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <Link to="/apply-leave" className="btn-primary mt-4 text-xs px-4 py-2">
              Apply Now
            </Link>
          </div>
        ) : (
