...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate immediately — no delay needed since isAuthenticated redirect handles it
            ...
            {mode === 'login' && (
              <div className="mb-5 p-3.5 bg-blue-50 border border-blue-100 rounded-lg">
                ...
                <div className="space-y-1 text-xs text-blue-600">
                  ...
                  <p>👨‍🏫 <strong>Faculty:</strong> faculty@college.edu / Faculty@123</p>
                </div>
              </div>
            )}
              ...
              {mode === 'register' && (
                <div className="p-3 bg-amber-50 border border-amber-100 rounded-lg">
                  <p className="text-xs text-amber-700">
                    <strong>Note:</strong> New registrations default to the <strong>Student</strong> role. Contact admin to create a Faculty account.
                  </p>
                </div>
              )}
